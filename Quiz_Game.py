...
palyer_name = input("Please enter your name : \n")
prompts = [
...
q0 = Quiz_game(prompts[0],)
q1 = Quiz_game(prompts[1],)
q2 = Quiz_game(prompts[2],)
q3 = Quiz_game(prompts[3],)
...
for questions in lst_of_prompts: 
    answer.append(input(questions.asking).upper())
    responses[palyer_name] = answer
print(responses)
